...
@app.route('/transaction/new', methods=['POST'])  # TODO stock this route in one variable. Use this variable instead of the route string where it is called in the program
