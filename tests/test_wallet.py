...
class TestMining(unittest.TestCase):
    ...
    def test_balance(self):
        ...
        response = self.app.post('/get_balance_by_token', json={'user_id': '45924479284721020088255655764259838493632121191345267194632595708284069229257A64353570746271633642239099441557900798355211921538755593764691886599926285870', 'token': 'BNB'})
